...
/**
 * Format a date in YYYY-MM-DD HH:MM form for naming playlists.
 */
...
/**
 * Construct a default playlist name based on the shuffle source.
 */
...
/**
 * React hook to manage shuffle job lifecycle. Provides functions to start shuffling
 * a liked songs collection or a specific playlist, monitors progress and exposes
 * a summary and progress ratio for UI display. Also supports cancelling and
 * resetting the job state.
 */
